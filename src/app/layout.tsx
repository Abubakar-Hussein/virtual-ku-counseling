...
export const metadata: Metadata = {
  title: {
    default: 'Virtual Counseling Booking and Scheduling System | Kenyatta University Counseling',
    template: '%s | Virtual Counseling Booking and Scheduling System'
  },
  ...
  authors: [{ name: 'Virtual Counseling Booking and Scheduling System Team' }],
  openGraph: {
    type: 'website',
    locale: 'en_KE',
    url: 'https://wellness.ku.ac.ke',
    siteName: 'Virtual Counseling Booking and Scheduling System',
    title: 'Virtual Counseling Booking and Scheduling System — Student Support Platform',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Virtual Counseling Booking and Scheduling System',
      },
    ],
  },
};

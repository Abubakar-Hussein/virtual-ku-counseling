    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
          <tr>
            <td style="background:linear-gradient(135deg,#1a3a5c 0%,#2563eb 100%);padding:32px 40px;text-align:center;">
              ...
              <p style="margin:6px 0 0;color:#bfdbfe;font-size:13px;">KU Wellness</p>
            </td>
          </tr>
          <tr>
        ...
        try {
            await sendEmail({
                to: SUPPORT_EMAIL,
                subject: `Support Request: ${contactType} — from ${name} | KU Wellness`,
                html: supportHtml,
      ...
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
          ...
          <tr>
            ...
            await sendEmail({
                to: email,
                subject: `We received your message | KU Wellness`,
                html: autoReplyHtml,

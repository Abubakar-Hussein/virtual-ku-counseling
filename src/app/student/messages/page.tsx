                ...
                <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
                    <div>
                        <div style={{
                            ...
                            <MessageCircle size={12} strokeWidth={2.5} /> Counselor Chat
                        </div>
                        <h1 style={{ fontSize: '1.9rem', fontWeight: 800, marginBottom: 4, letterSpacing: '-0.02em', color: 'var(--text-primary)' }}>
                            Messages
                        </h1>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', margin: 0 }}>
                            Chat directly with your matched counselor between scheduled sessions.
                        </p>
                    </div>
                    <NotificationBell />
                </header>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'var(--bg-card)' }}>
                        {selectedContact ? (
                            ...
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: 'var(--text-muted)' }}>
                                ...
                                <p style={{ fontSize: '0.88rem' }}>Choose a counselor from the sidebar to open your messages.</p>
                            </div>
                        )}
                    </div>
                </div>

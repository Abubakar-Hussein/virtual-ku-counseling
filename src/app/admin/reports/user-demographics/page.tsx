...
export default function UserDemographicsPage() {
    ...
    const printReport = async () => {
        ...
        try {
            ...
            } else { showToast('No user data found for the selected filters.', 'error'); }
        ...
        <div className="dashboard-layout">
            ...
            <main className="dashboard-content page-transition">
                ...
                <div style={{ marginBottom: 24 }}>
                    <Link href="/admin/reports" style={{ color: 'var(--ku-gold)', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                        ← Back to Reports
                    </Link>
                </div>
                ...
                <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                        <div style={{ fontSize: '2rem', width: 52, height: 52, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 14, background: 'rgba(155,126,73,0.15)', border: '1px solid rgba(155,126,73,0.3)' }}>👥</div>
                        <div>
                            <h1 style={{ fontSize: '1.6rem', fontWeight: 800, margin: 0 }}>Users Demographics</h1>
                            <p style={{ color: 'var(--text-secondary)', margin: 0, fontSize: '0.9rem' }}>Filter, preview, and print user demographic reports.</p>
                        </div>
                    </div>
                    <NotificationBell />
                </header>
                ...
                {previewData.length > 0 && (
                    <div className="glass" style={{ padding: 24, overflowX: 'auto' }}>
                        ...
                        {previewData.length > 10 && <p style={{ marginTop: 12, fontSize: '0.8rem', color: 'var(--text-muted)', textAlign: 'center' }}>Showing first 10 of {previewData.length} records. Print for full report.</p>}
                    </div>
                )}

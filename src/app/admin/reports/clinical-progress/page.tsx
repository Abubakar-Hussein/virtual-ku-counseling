            ...
            <main className="dashboard-content page-transition">
                ...
                <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                        <div style={{ fontSize: '2rem', width: 52, height: 52, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 14, background: 'rgba(236,72,153,0.15)', border: '1px solid rgba(236,72,153,0.3)' }}>🩹</div>
                        <div>
                            <h1 style={{ fontSize: '1.6rem', fontWeight: 800, margin: 0 }}>Clinical Progress</h1>
                            <p style={{ color: 'var(--text-secondary)', margin: 0, fontSize: '0.9rem' }}>Filter, preview, and print clinical progress reports.</p>
                        </div>
                    </div>
                    <NotificationBell />
                </header>
                ...
                <div className="glass" style={{ padding: 24, marginBottom: 28 }}>
                    ...
                    <div style={{ display: 'flex', gap: 10, marginTop: 20 }}>
                        <button className="btn-primary" onClick={fetchPreview} disabled={previewLoading} style={{ fontSize: '0.85rem', background: 'linear-gradient(135deg, #ec4899, #be185d)' }}>
                            {previewLoading ? '⏳ Loading...' : '👁 Preview Data'}
                        </button>
                        <button onClick={printReport} disabled={printing} style={{
                            padding: '10px 20px', borderRadius: 12, border: '1px solid #ec4899', background: 'transparent',
                            color: '#f472b6', fontWeight: 600, fontSize: '0.85rem', cursor: printing ? 'not-allowed' : 'pointer',

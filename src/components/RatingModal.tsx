                    ...
                    {[1, 2, 3, 4, 5].map(star => (
                        <button
                            ...
                            style={{
                                ...
                                cursor: 'pointer',
                                fontSize: '2.5rem',
                                color: star <= (hoverRating || rating) ? '#facc15' : 'rgba(255,255,255,0.15)',
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            borderRadius: 20,
                                            fontSize: '0.8rem',
                                            border: `1px solid ${isSelected ? 'var(--ku-green-light)' : 'rgba(255,255,255,0.1)'}`,
                                            background: isSelected ? 'rgba(0,136,68,0.15)' : 'rgba(255,255,255,0.03)',
                ...
                <div style={{ display: 'flex', gap: 12, marginTop: 10 }}>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            borderRadius: 10,
                            border: 'none',
                            background: rating > 0 ? 'linear-gradient(135deg, var(--ku-green), var(--ku-green-light))' : 'rgba(255,255,255,0.1)',
